...
export class WaterMesh extends BufferedMesh {
  constructor({
    ...
    this.material = new THREE.MeshBasicMaterial( {color: 0x0000ff, side: THREE.DoubleSide, transparent: true, opacity: 0.8, depthWrite: false} );
  ...
  update() {
    ...
    if (currentChunkPhysicObject) { 
      ...
      // handle particle
      this.updateParticle(contactWater, localPlayer, currentWaterSurfaceHeight)
    }
  }
}